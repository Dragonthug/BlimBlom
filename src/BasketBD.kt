...
class BasketBD(val context : Context, factory : SQLiteDatabase.CursorFactory?)
: SQLiteOpenHelper(context,"basket_products",factory,1)
{
    companion object {
    private const val DATABASE_NAME = "basket.db"
